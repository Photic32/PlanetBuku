...
from home.views import register, logout_user, show_home, get_book_json, get_peminjaman_json, get_keranjang_json, submit_cart, show_keranjang, getBukuKeranjang_json, get_bukuPeminjaman_json, get_reviews_json, get_bukuReviews_json, remove_cart, show_profile, getBukuKeranjangFlutter_json
...
urlpatterns = [
    ...
    path('get-buku-keranjang-id/<int:id>/', getBukuKeranjangFlutter_json, name='getBukuKeranjangFlutter_json'),
